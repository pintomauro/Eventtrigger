...
class App extends Component {
  ...
  listenToPaymentEvent = () => {
    ...
    if (evt.returnValues._step === "1"){
      ...
      let itemPaid = await self.itemManager.methods.items(evt.returnValues.itemindex).call();     
      console.log(itemPaid);
      alert("item" + itemPaid._identifier + "was paid, delivery it now!");
    };  
    console.log(evt);  
    }); 
  }
  ...
  handleSubmit = async() => {
    ...
    console.log(itemName, cost, this.itemManagee) 
